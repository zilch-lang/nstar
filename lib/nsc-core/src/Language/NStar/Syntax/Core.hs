...
data Instruction where
  ...
  CJGE ::
    ...
    Located Expr ->
    Instruction
  -- | @cjle@ changes the control flow to the first label if the first parameter is less than or equal to the second parameter, else to the second label.
  CJLE ::
    Located Expr ->
    Located Expr ->
    -- | The first label
    ...
    Located Expr ->
    Instruction
  -- | @cjg@ changes the control flow to the first label if the first parameter is greater than the second parameter, else to the second label.
  CJG ::
    Located Expr ->
    Located Expr ->
    -- | The first label
    ...
    Located Expr ->
    Instruction
  -- | @cje@ changes the control flow to the first label if the first parameter is equal to the second parameter, else to the second label.
  CJE ::
    Located Expr ->
    Located Expr ->
    -- | The first label
    ...
    Located Expr ->
    Instruction
  -- | @cjne@ changes the control flow to the first label if the first parameter is not equal to the second parameter, else to the second label.
  CJNE ::
    Located Expr ->
    Located Expr ->
    -- | The first label
...
data Token where
  ...
  Cjge :: Token
  -- | The @cjle@ instruction
  Cjle :: Token
  -- | The @cjg@ instruction
  Cjg :: Token
  -- | The @cje@ instruction
  Cje :: Token
  -- | The @cjne@ instruction
  Cjne :: Token
  -- TODO: add more instructions
  -- Symbols
