...
data TypedInstruction where
  ...
  CMVL ::
    ...
    Located Register ->
    TypedInstruction
  -- | Moves @c@ inside @r@ if @a@ is less than or equal to @b@, otherwise move @d@ inside @r@.
  CMVLE ::
    -- | > a
    Located Expr ->
    -- | > b
    ...
    Located Register ->
    TypedInstruction
  -- | Moves @c@ inside @r@ if @a@ is equal to @b@, otherwise move @d@ inside @r@.
  CMVE ::
    -- | > a
    Located Expr ->
    -- | > b
  ...
  CJZ ::
    ...
    Located Expr ->
    TypedInstruction
  -- | Jump to @l₁@ if @a@ is less than @b@, otherwise jump to @l₂@.
  CJL ::
    -- | > a
    Located Expr ->
    -- | > b
    ...
    Located Expr ->
    TypedInstruction
  -- | Jump to @l₁@ if @a@ is less than or equal to @b@, otherwise jump to @l₂@.
  CJLE ::
    -- | > a
    Located Expr ->
    -- | > b
